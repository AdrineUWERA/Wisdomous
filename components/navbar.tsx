            ...
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
              <a
                className={`font-medium ${
                  isLanding
                    ? "text-blue-600 md:py-6 dark:text-blue-500"
                    : "text-gray-500 hover:text-gray-400 md:py-6 dark:text-gray-400 dark:hover:text-gray-500"
                }`}
                href="/"
                aria-current="page"
              >
              ...
              <a
                className={`flex items-center gap-x-2 font-medium ${
                  isLogIn ? "text-blue-600 dark:text-blue-500" : "text-gray-500"
                } hover:text-blue-600 md:border-s md:border-gray-300 md:my-6 md:ps-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500`}
                href="/login"
              >
                <svg
