  ...
  return (
    <div className="flex h-full items-center">
      ...
      <div className="w-full h-[100vh] pt-20 px-4 sm:px-6 md:px-8 lg:ps-72">
        <p className="pb-6 text-2xl font-semibold text-blue-600">
          Edit Profile
        </p>
        <div className="w-full justify-around items-center px-4 py-8 flex ">
          <form className="w-[700px] bg-white p-10 border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
