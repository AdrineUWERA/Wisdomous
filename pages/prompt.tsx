...
export default function Prompt() {
  ...
  const [optimized_promp, setOptimizedPromp] = useState("");
  ...
  return (
    <div className="min-h-screen">
      <div className="relative h-screen">
        {<div className="py-10 lg:py-14 h-[80%]">

        </div>}

        <div className="sticky bottom-0 z-10 bg-white border-t border-gray-200 pt-2 pb-3 sm:pt-4 sm:pb-6 dark:bg-slate-900 dark:border-gray-700">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative">
              <textarea
                ...
                className="p-4 pb-12 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-white-600"
